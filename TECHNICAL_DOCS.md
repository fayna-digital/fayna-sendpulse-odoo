...
**ЛОГ — КРИТИЧНИЙ ІНЦИДЕНТ (2026-04-09), червоний рівень**

Критична помилка: **невиконання мети** та порушення межі — зміни в SendPulse заборонені були контрактом задачі; правки все одно потрапили в цей модуль. **Відкат** `main` → коміт **`6905fa7`**. Обов’язкове правило: будь-які майбутні зміни SendPulse лише за окремим ТЗ; інтеграція Discuss/Omnichannel — у **`omnichannel_bridge`**.

Повний розбір (файли, коміти, ремедіація): **`docs/CRITICAL_INCIDENT_AI_INTERVENTION_2026-04-09.md`**.
