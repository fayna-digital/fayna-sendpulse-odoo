...
## 📜 ЗАКОН (непорушний флоу)

1. **Правильний код живе ЛОКАЛЬНО** — це місце для роботи.
2. Потім комітиться на **GitHub** — це **єдине джерело правди**.
3. Далі все йде на **staging** для тестів.
4. І лише потім на **prod**. Крапка.

**Репо-закон:** у корпоративний `fayna-digital` йдуть **лише** репо, які на продаж і які **почищені та стерильні**. Робочий код для staging/prod живе в особистому робочому репо (`VladSh77`). Ніколи не форс-пушити робочу/брудну історію в корпоративний репо і не плутати напрямок синхронізації.
