...
class ChannelBridgeController(http.Controller):
    ...
    def telegram_webhook(self, token):
        ...
        try:
            ...
            _logger.error('Channel Bridge: telegram processing failed — %s', e, exc_info=True)
    ...
    def messenger_webhook_verify(self):
        ...
        for service in ('messenger', 'instagram'):
            ...
            if backend and backend.webhook_secret and verify_token == backend.webhook_secret:
    ...
    def _process_incoming(
        ...
        try:
            ...
            _logger.error('Channel Bridge: %s processing failed — %s', service, e, exc_info=True)
            return False, str(e)
        return True, None
