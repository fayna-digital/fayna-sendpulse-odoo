...
class TestPackage5Gallery(TransactionCase):
    ...
    def test_d1_kanban_has_action_button(self):
        ...
        self.assertIn(
            'name="action_open_backend"', arch, "має бути кнопка «Відкрити канал»"
        )
    ...
    def test_d1_kanban_shows_description(self):
        ...
        self.assertIn(
            "o_kanban_description", arch, "description має бути в блоці опису"
        )
    ...
    def test_d1_kanban_has_channel_icon(self):
        ...
        icon_path = os.path.join(
            _MODULE_DIR, "static", "img", "channel_placeholder.svg"
        )
        self.assertTrue(
...
class TestPackage5Ux(TransactionCase):
    ...
    def test_d2_backend_action_has_help(self):
        ...
        self.assertTrue(
            action.help, "help у action_channel_backend не має бути порожнім"
        )
    ...
    def test_d2_backend_list_headers_not_truncated(self):
        ...
        self.assertNotIn(
            'name="active"', arch, "булеву колонку active прибрано зі списку"
        )
        self.assertNotIn(
...
class TestUxAuditFixes(TransactionCase):
    ...
    def test_n9_backend_list_shows_last_error(self):
        ...
        view = self.env.ref("fayna_channel_bridge.view_channel_backend_list")
        self.assertIn(
            'name="last_error"', view.arch, "у списку каналів має бути last_error"
        )
    ...
    def test_s6_t8_disconnect_archives_backend(self):
        ...
        provider = self.env["channel.provider"].search(
            [("service", "=", "livechat")], limit=1
        )
        ...
        self.assertFalse(
            backend.active, "після disconnect backend має бути архівований"
        )
