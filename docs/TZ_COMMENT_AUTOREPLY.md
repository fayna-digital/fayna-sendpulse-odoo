...
Система по черзі використовує один з 3 варіантів публічної відповіді:
- Варіант 1: "Дякуємо за коментар! 🏕️ Написали вам детальніше у приватні — перевірте вхідні 😊"
- Варіант 2: "Дякуємо! 🌟 Поширили інформацію у повідомленнях — гляньте в особисті 😊"
- Варіант 3: "Радіємо вашій зацікавленості! ✨ Надіслали деталі в особисті — чекаємо вас там 🏕️"

Ротація по `(count of existing sp_is_comment records) % 3`.
