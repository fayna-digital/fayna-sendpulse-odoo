...
- **[INCIDENT_MESSAGE_LOSS_2026-07-19.md](INCIDENT_MESSAGE_LOSS_2026-07-19.md)** — race condition у webhook-обробці, тиха втрата вхідних повідомлень (v17.0.15.3–15.8, продуктовий баг, не AI-інцидент)
